...
#define DEV_TYPE_FLAG_FACE_DEEP_2052    0x10000 //FDEEP5M FDEEP5TM FINGERPRINT_DATA_LEN_2052 代替 DEV_TYPE_FLAG_FP_LEN_10240 FDEEP3M FDEEP3TM
#define DEV_TYPE_FLAG_FACEPASS_15360    0x20000 //FACE7
#define DEV_TYPE_FLAG_FACEPASS_2056     0x40000 //FACE7FAI
#define DEV_TYPE_FLAG_FACEPASS_1028     0x80000 //FDEEP5 FDEEP5T FDEEP3 FDEEP3T

#define DEV_TYPE_FLAG_FACEPASS_PICTURE  0x800000 //支持人脸图片数据模块 (FDEEP5 FDEEP5T FDEEP5M FDEEP5TM,FDEEP3 FDEEP3T FDEEP3M FDEEP3TM)

#define DEV_TYPE_FLAG_RECORD_COMMON         0x100000 //通用记录
#define DEV_TYPE_FLAG_RECORD_TM             0x200000 //测温或口罩记录 (FACE7T FACE7M FACE7TM  FDEEP5T, FDEEP5M, FDEEP5TM  FDEEP3T, FDEEP3M, FDEEP3TM ,PASS7PT PASS7PM PASS7PTM)
#define DEV_TYPE_FLAG_RECORD_TEMPERATURE_T  0x400000 //支持获取测温记录图片 (FACE7TM  FACE7T FDEEP5T FDEEP5TM FDEEP3T FDEEP3TM PASS7PT PASS7PTM)
 ...
 *                                  COMMON  : SetRecordflag = 0,SetLogFile = 0,SetAutodownload = 0;
 *                                  BolidW2 : SetRecordflag = 1,SetLogFile = 0,SetAutodownload = 1;
*****************************************************************************/
...
/*****************************************************************************
 * 机型：FACE7TM 下载口罩测温考勤全部记录  测温或口罩记录 (FACE7EI FACE7T FACE7M FACE7TM  FDEEP5T, FDEEP5M, FDEEP5TM FDEEP3T, FDEEP3M, FDEEP3TM)
...
/*****************************************************************************
 * 机型：FACE7TM 下载口罩测温考勤全部新记录  测温或口罩记录 (FACE7EI FACE7T FACE7M FACE7TM  FDEEP5T, FDEEP5M, FDEEP5TM FDEEP3T, FDEEP3M, FDEEP3TM)
 * 信息返回类型:CCHEX_RET_TM_NEW_RECORD_INFO_TYPE
 * 信息解析结构:CCHEX_RET_TM_RECORD_INFO_STRU
 *****************************************************************************/
API_EXTERN int CChex_TM_DownloadAllNewRecords(void *CchexHandle, int DevIdx);
/*****************************************************************************
 * 机型：FACE7TM 上传口罩测温考勤记录  测温或口罩记录 (FACE7EI FACE7T FACE7M FACE7TM  FDEEP5T, FDEEP5M, FDEEP5TM FDEEP3T, FDEEP3M, FDEEP3TM)
...
/*****************************************************************************
 * 机型：FACE7TM 下载指定员工指定时间内口罩测温考勤记录  (FACE7EI FACE7T FACE7M FACE7TM  FDEEP5T, FDEEP5M, FDEEP5TM FDEEP3T, FDEEP3M, FDEEP3TM)
